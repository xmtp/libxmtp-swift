 ...
 */
public func ethereumAddressFromPubkey(pubkey: Data) -> String  {
    return try!  FfiConverterString.lift(try! rustCall() {
 ...
 */
public func secpGeneratePublicKey(privateKey32: Data)throws  -> Data  {
    return try  FfiConverterData.lift(try rustCallWithError(FfiConverterTypeFfiCryptoError_lift) {
    uniffi_xmtpv3_fn_func_secp_generate_public_key(
 ...
 */
public func secpSignRecoverable(msg: Data, privateKey32: Data, hashing: Bool)throws  -> Data  {
    return try  FfiConverterData.lift(try rustCallWithError(FfiConverterTypeFfiCryptoError_lift) {
    uniffi_xmtpv3_fn_func_secp_sign_recoverable(
...
private let initializationResult: InitializationResult = {
    ...
    if (uniffi_xmtpv3_checksum_func_ethereum_address_from_pubkey() != 7300) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_xmtpv3_checksum_func_secp_generate_public_key() != 39892) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_xmtpv3_checksum_func_secp_sign_recoverable() != 53475) {
        return InitializationResult.apiChecksumMismatch
    }
