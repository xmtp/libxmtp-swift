...
open class FfiConversationMetadata:
    FfiConversationMetadataProtocol
{
    fileprivate let pointer: UnsafeMutableRawPointer!
...
public protocol FfiConversationsProtocol: AnyObject {
    ...
    func streamAllDmMessages(messageCallback: FfiMessageCallback) async -> FfiStreamCloser

    func streamAllGroupMessages(messageCallback: FfiMessageCallback) async -> FfiStreamCloser
    ...
    FfiConversationsProtocol
{
    ...
    open func streamAllDmMessages(messageCallback: FfiMessageCallback) async -> FfiStreamCloser {
        return
            try! await uniffiRustCallAsync(
                rustFutureFunc: {
    ...
    open func streamAllGroupMessages(messageCallback: FfiMessageCallback) async -> FfiStreamCloser {
        return
            try! await uniffiRustCallAsync(
                rustFutureFunc: {
    ...
    FfiXmtpClientProtocol
{
    ...
    open func verifySignedWithInstallationKey(signatureText: String, signatureBytes: Data) throws { try rustCallWithError(FfiConverterTypeGenericError.lift) {
    ...
    open func verifySignedWithPublicKey(signatureText: String, signatureBytes: Data, publicKey: Data) throws { try rustCallWithError(FfiConverterTypeGenericError.lift) {
...
public struct FfiCreateGroupOptions {
    ...
    public var messageExpirationFromMs: Int64?
    public var messageExpirationMs: Int64?

    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(permissions: FfiGroupPermissionsOptions?, groupName: String?, groupImageUrlSquare: String?, groupDescription: String?, groupPinnedFrameUrl: String?, customPermissionPolicySet: FfiPermissionPolicySet?, messageExpirationFromMs: Int64?, messageExpirationMs: Int64?) {
        ...
        self.messageExpirationFromMs = messageExpirationFromMs
        self.messageExpirationMs = messageExpirationMs
    }
}
...
extension FfiCreateGroupOptions: Equatable, Hashable {
    public static func == (lhs: FfiCreateGroupOptions, rhs: FfiCreateGroupOptions) -> Bool {
        ...
        if lhs.messageExpirationFromMs != rhs.messageExpirationFromMs {
            return false
        }
        if lhs.messageExpirationMs != rhs.messageExpirationMs {
            return false
        }
        return true
    }
    ...
    public func hash(into hasher: inout Hasher) {
        ...
        hasher.combine(messageExpirationFromMs)
        hasher.combine(messageExpirationMs)
    }
}
...
public struct FfiConverterTypeFfiCreateGroupOptions: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> FfiCreateGroupOptions {
        return
            try FfiCreateGroupOptions(
                ...
                messageExpirationFromMs: FfiConverterOptionInt64.read(from: &buf),
                messageExpirationMs: FfiConverterOptionInt64.read(from: &buf)
            )
    }
    ...
    public static func write(_ value: FfiCreateGroupOptions, into buf: inout [UInt8]) {
        ...
        FfiConverterOptionInt64.write(value.messageExpirationFromMs, into: &buf)
        FfiConverterOptionInt64.write(value.messageExpirationMs, into: &buf)
    }
}
...
public struct FfiMessage {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(id: Data, sentAtNs: Int64, convoId: Data, senderInboxId: String, content: Data, kind: FfiConversationMessageKind, deliveryStatus: FfiDeliveryStatus) {
        self.id = id
...
public struct FfiPermissionPolicySet {
    ...
    public var updateMessageExpirationMsPolicy: FfiPermissionPolicy

    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(addMemberPolicy: FfiPermissionPolicy, removeMemberPolicy: FfiPermissionPolicy, addAdminPolicy: FfiPermissionPolicy, removeAdminPolicy: FfiPermissionPolicy, updateGroupNamePolicy: FfiPermissionPolicy, updateGroupDescriptionPolicy: FfiPermissionPolicy, updateGroupImageUrlSquarePolicy: FfiPermissionPolicy, updateGroupPinnedFrameUrlPolicy: FfiPermissionPolicy, updateMessageExpirationMsPolicy: FfiPermissionPolicy) {
        ...
        self.updateMessageExpirationMsPolicy = updateMessageExpirationMsPolicy
    }
}
...
extension FfiPermissionPolicySet: Equatable, Hashable {
    public static func == (lhs: FfiPermissionPolicySet, rhs: FfiPermissionPolicySet) -> Bool {
        ...
        if lhs.updateMessageExpirationMsPolicy != rhs.updateMessageExpirationMsPolicy {
            return false
        }
        return true
    }
    ...
    public func hash(into hasher: inout Hasher) {
        ...
        hasher.combine(updateMessageExpirationMsPolicy)
    }
}
...
public struct FfiConverterTypeFfiPermissionPolicySet: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> FfiPermissionPolicySet {
        return
            try FfiPermissionPolicySet(
                ...
                updateMessageExpirationMsPolicy: FfiConverterTypeFfiPermissionPolicy.read(from: &buf)
            )
    }
    ...
    public static func write(_ value: FfiPermissionPolicySet, into buf: inout [UInt8]) {
        ...
        FfiConverterTypeFfiPermissionPolicy.write(value.updateMessageExpirationMsPolicy, into: &buf)
    }
}
...
private var initializationResult: InitializationResult = {
    ...
    if uniffi_xmtpv3_checksum_method_ffixmtpclient_verify_signed_with_installation_key() != 4340 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_xmtpv3_checksum_method_ffixmtpclient_verify_signed_with_public_key() != 21532 {
        return InitializationResult.apiChecksumMismatch
    }
